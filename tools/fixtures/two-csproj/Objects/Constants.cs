...
/// pair (set name, key); which sheet a row sits in makes no difference to this file, so you
/// can regroup sheets freely without touching it.</para>
///
...
public class Constants
{
    ...
    /// tab reads, by name, so expect the values to change between runs with no code change at all.
    /// A rate kept in another lkp_ sheet works and is invisible on that page.
    /// </summary>
