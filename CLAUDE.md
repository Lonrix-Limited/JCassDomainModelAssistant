...
Beyond the procedure above, this file carries no knowledge of its own — three copies of a fact
become three different facts. `AGENTS.md` and `.github/copilot-instructions.md` say the same thing
